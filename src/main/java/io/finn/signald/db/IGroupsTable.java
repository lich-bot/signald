...
public interface IGroupsTable {
  ...
  void upsert(GroupMasterKey masterKey, int revision, DecryptedGroup decryptedGroup, DistributionId distributionId, int lastAvatarFetch) throws SQLException;
  ...
  default void upsert(GroupMasterKey masterKey, int revision, DecryptedGroup decryptedGroup) throws SQLException { upsert(masterKey, revision, decryptedGroup, null, -1); }
