...
public class RemoteDeleteRequest implements RequestType<SendResponse> {
  ...
  public SendResponse run(Request request)
      throws InvalidKeyException, IOException, InvalidProxyException, SQLException, NoSuchAccount, ServerNotFoundException, InvalidRecipientException, UnknownGroupException {
