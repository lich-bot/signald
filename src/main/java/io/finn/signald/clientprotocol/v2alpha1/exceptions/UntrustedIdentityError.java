...
public class UntrustedIdentityError extends ExceptionWrapper {
  ...
  public UntrustedIdentityError(UUID accountUUID, UntrustedIdentityException e) throws InternalError, ServerNotFoundError, InvalidProxyError, NoSuchAccountError {
